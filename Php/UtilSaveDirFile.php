...
// Create directories if necessary and save file on the server
// ------------------------------------------------------------
//
...
// "UtilSaveDirFile.php":  URL parameter specifies the URL you wish to request
...
else
{
    ...
    fwrite($debug_file, "Directory was created \r\n");
}
